...
@Component({
	selector: 'app-go-class-page',
	template: `<app-go-class *ngIf="showModule" [defaultGeneType]="defaultGeneType">
...
@Component({
	selector: 'app-go-class',
	templateUrl: './go-class.component.html',
	styles: []
})
export class GoClassComponent implements OnInit {
